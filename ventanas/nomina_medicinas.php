...
header ("Content-Disposition: attachment; filename=nomina_medicinas.xls");
?>
...
{
	$gastonomina = $_GET['gasto'];
	$dependencianomina = $_GET['dependencia'];
	$mesnomina = $_GET['mes'];
	$anionomina = $_GET['anio'];
	$analistanomina = $_GET['analista'];
...
$sqlfact=mysql_query("select distinct cedula_trab from factura_trab where month(fecha_fact) = '".$mesnomina."' and year(fecha_fact) = '".$anionomina."' and apellido_fact = '".$dependencianomina."' and tipogasto_fact = '".$gastonomina."' order by cedula_trab") or die ("Error linea 60 ".mysql_error());
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" colspan="9"><strong>N&oacute;mina de <?php echo $_GET['gasto']; ?> del Personal <?php echo $_GET['dependencia']; ?>,  <?php echo $mesnominaver ?> del <?php echo $_GET['anio'] ?></strong></td>
  </tr>
</table>
...
<table width="750" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="90" align="center" valign="middle">Gastos en Medicinas</td>
