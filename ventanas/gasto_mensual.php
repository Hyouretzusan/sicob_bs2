...
<input name="sec" type="hidden" value="ventanas/gasto_mensual" />
...
$stringbuscarfact=mysql_query("select * from factura_trab where month(fecha_fact) = '$mesnomina' and year(fecha_fact) = '$anionomina' and cedula_trab = '$cedulanomina' order by fecha_fact") or die ("Error: Linea 84".mysql_error());
