...
if(isset($_GET[enviar_fact]))
	...
	for($j=1;$j<=$cantidadtasarevision;$j++)
	{
		...
		if($salida==false)
	{
		$stringfacturafamiliar="insert into factura_trab (codigo_fact, nombre_fact, observacion_fact, fecha_fact, monto_fact, tipogasto_fact) values ('$_GET[codigo_fact]','$_GET[nombre_fact]','$_GET[observacion_fact]','$_GET[fecha_fact]','$_GET[monto_fact]','$_GET[tipogasto_fact]')";
