...
--
-- Servidor: localhost
-- Tiempo de generación: 20-11-2013 a las 19:12:03
...
-- Base de datos: `sicob`
--
CREATE DATABASE `sicob` DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci;
USE `sicob`;
...
CREATE TABLE IF NOT EXISTS `factura_trab` (
  ...
  `dependencia_fact` varchar(20) COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `factura_trab` (`codigo_fact`, `nombre_fact`, `apellido_fact`, `cedula_fact`, `observacion_fact`, `fecha_fact`, `monto_fact`, `tipogasto_fact`, `cedula_trab`, `identificador`, `dependencia_fact`) VALUES
...
('00000', 'asd', '', 0, 'prueba cedula trabajador en comun tabla factura', '2013-11-20', 300, 'Medicinas/Odontologia', 5393092, 'Familiar', ''),
('150', 'saas', '', 18928948, 'prueba cedula_fact 18928948', '2013-11-20', 150, 'Medicinas/Odontologia', 5393092, 'Familiar', ''),
('9919', 'farmatodo', '', 18928948, 'prueba yo mi cedula en cedula_fact', '2013-11-20', 25, 'Medicinas/Odontologia', 18928948, 'Trabajador', '');
...
CREATE TABLE IF NOT EXISTS `familiar` (
  ...
  `dependencia_fam` varchar(20) COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `familiar` (`cedula_trab`, `cedula_fam`, `apellido_fam`, `nombre_fam`, `sexo_fam`, `parentesco_fam`, `fecnac_fam`, `patologia_fam`, `discapacidad_fam`, `salmedod_fam`, `sallen_fam`, `salprot_fam`, `codigo_fam`, `identificador_fam`, `dependencia_fam`) VALUES
(0, 23456789, 'SAJKDFNJKSDF', 'Familiar', '1', '1', '0000-00-00', '0', '0', 0, 0, 0, '345678', '', ''),
...
(18928948, 5393092, 'Martinez', 'Zaida', 'Femenino', 'Madre', '1967-08-20', 'No', 'No', 4050, 80, 10000, '1001', '', 'Obrero'),
...
(18928948, 'Guion', 'Claudio', 'Masculino', '2013-04-01', 'Programador', 'Obrero', '7171', '1987-08-10', 4025, 65, 5000, 'Trabajador', ''),
